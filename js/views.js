...
window.Views = {
            ...
            <div class="pos-cart">
                ...
                <div class="cart-totals bg-dark-blue p-3">
                    ...
                    <div class="d-flex justify-content-between mb-2 align-items-center small text-white-50">
                        <span data-i18n="coolie_charges">Coolie / Charges (+):</span>
                        <input type="number" id="pos-charges" class="form-control form-control-sm w-25 bg-dark text-white border-secondary text-end" value="0" style="position: relative; z-index: 100; pointer-events: auto;">
                    </div>
                    <div class="d-flex justify-content-between mb-2 align-items-center small text-white-50">
                        <span data-i18n="discount_label">Discount (-):</span>
                        <input type="number" id="pos-discount" class="form-control form-control-sm w-25 bg-dark text-white border-secondary text-end" value="0" style="position: relative; z-index: 100; pointer-events: auto;">
                    </div>
            ...
            <div class="col-lg-4 d-flex flex-column">
                <div class="card border-0 shadow-sm bg-dark text-white mb-3">
                    <div class="card-body text-center py-4">
                        <h6 class="text-white-50 small mb-1" data-i18n="purchase_id">PURCHASE ID</h6>
                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body bg-light">
                        ...
                        <div class="d-flex justify-content-between mb-2 align-items-center">
                            <span class="text-muted" data-i18n="coolie_charges">Transport/Loading (+):</span>
                        ...
                        <div class="d-flex justify-content-between mb-2 align-items-center">
                            <span class="text-muted" data-i18n="discount_label">Discount (-):</span>
    ...
    reports: `
        <div class="row g-3 reports-module">
            <!-- Left Navigation Menu (3 Columns) -->
            <div class="col-lg-3 col-md-4">
                <div class="card border-0 shadow-sm reports-sidebar sticky-top" style="top: 90px; z-index: 10;">
                    <div class="card-header bg-dark-blue text-white py-3">
                        <h6 class="mb-0 fw-bold"><i class="fas fa-chart-line me-2"></i>Reports Center</h6>
                    </div>
                    <div class="accordion accordion-flush text-start" id="reportsAccordion">
                        <!-- SALES REPORTS -->
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingSales">
                                <button class="accordion-button fw-bold py-3 text-primary bg-light bg-opacity-50" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSales">
                                    <i class="fas fa-file-invoice-dollar me-2 text-primary"></i> Sales Reports
                                </button>
                            </h2>
                            <div id="collapseSales" class="accordion-collapse collapse show" data-bs-parent="#reportsAccordion">
                                <div class="list-group list-group-flush small">
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4 active" onclick="ReportLogic.selectReport('sales_today', event)">Today Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_yesterday', event)">Yesterday Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_weekly', event)">Weekly Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_monthly', event)">Monthly Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_custom', event)">Custom Date Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_invoice_wise', event)">Invoice-wise Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_item_wise', event)">Item-wise Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_category_wise', event)">Category-wise Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_staff_wise', event)">Staff-wise Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_counter_wise', event)">Counter-wise Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_mark_wise', event)">Mark-wise Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_hourly_graph', event)">Hourly Sales Graph</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_profit_loss', event)">Profit & Loss Summary</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_tax_summary', event)">Tax Summary</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('sales_discount_summary', event)">Discount Summary</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingPurchase">
                                <button class="accordion-button collapsed fw-bold py-3 text-success" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePurchase">
                                    <i class="fas fa-truck-loading me-2 text-success"></i> Purchase Reports
                                </button>
                            </h2>
                            <div id="collapsePurchase" class="accordion-collapse collapse" data-bs-parent="#reportsAccordion">
                                <div class="list-group list-group-flush small">
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pur_supplier_report', event)">Supplier Purchase Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pur_stock_history', event)">Stock Purchase History</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pur_return_report', event)">Purchase Return Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pur_pending_payment', event)">Pending Supplier Payments</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingStock">
                                <button class="accordion-button collapsed fw-bold py-3 text-warning" type="button" data-bs-toggle="collapse" data-bs-target="#collapseStock">
                                    <i class="fas fa-boxes me-2 text-warning"></i> Stock Reports
                                </button>
                            </h2>
                            <div id="collapseStock" class="accordion-collapse collapse" data-bs-parent="#reportsAccordion">
                                <div class="list-group list-group-flush small">
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('stock_current', event)">Current Stock</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('stock_low_alert', event)">Low Stock Alert</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('stock_out', event)">Out of Stock Items</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('stock_fast_moving', event)">Fast Moving Products</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('stock_slow_moving', event)">Slow Moving Products</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('stock_expiry', event)">Expiry Product Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('stock_damaged', event)">Damaged Product Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('stock_adjustment', event)">Stock Adjustment History</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingCustomer">
                                <button class="accordion-button collapsed fw-bold py-3 text-info" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCustomer">
                                    <i class="fas fa-users me-2 text-info"></i> Customer Reports
                                </button>
                            </h2>
                            <div id="collapseCustomer" class="accordion-collapse collapse" data-bs-parent="#reportsAccordion">
                                <div class="list-group list-group-flush small">
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('cust_purchase_history', event)">Customer Purchase History</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('cust_due_balance', event)">Due Balance Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('cust_loyalty_points', event)">Loyalty Points Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('cust_top_customers', event)">Top Customers</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('cust_credit_report', event)">Customer Credit Report</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingPayment">
                                <button class="accordion-button collapsed fw-bold py-3 text-indigo" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePayment" style="color: #6610f2;">
                                    <i class="fas fa-money-check-alt me-2" style="color: #6610f2;"></i> Payment Reports
                                </button>
                            </h2>
                            <div id="collapsePayment" class="accordion-collapse collapse" data-bs-parent="#reportsAccordion">
                                <div class="list-group list-group-flush small">
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pay_cash', event)">Cash Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pay_upi', event)">UPI Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pay_card', event)">Card Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pay_credit', event)">Credit Sales</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pay_mixed', event)">Mixed Payment Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('pay_daily_cash_close', event)">Daily Cash Closing Report</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingExpense">
                                <button class="accordion-button collapsed fw-bold py-3 text-danger" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExpense">
                                    <i class="fas fa-wallet me-2 text-danger"></i> Expense Reports
                                </button>
                            </h2>
                            <div id="collapseExpense" class="accordion-collapse collapse" data-bs-parent="#reportsAccordion">
                                <div class="list-group list-group-flush small">
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('exp_daily', event)">Daily Expense</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('exp_monthly', event)">Monthly Expense</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('exp_category', event)">Expense Category Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('exp_net_profit_calc', event)">Net Profit Calculation</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingGST">
                                <button class="accordion-button collapsed fw-bold py-3 text-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseGST">
                                    <i class="fas fa-receipt me-2 text-secondary"></i> GST / Tax Reports
                                </button>
                            </h2>
                            <div id="collapseGST" class="accordion-collapse collapse" data-bs-parent="#reportsAccordion">
                                <div class="list-group list-group-flush small">
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('gst_summary', event)">GST Summary</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('gst_tax_wise', event)">Tax Wise Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('gst_hsn_wise', event)">HSN Report</a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 px-4" onclick="ReportLogic.selectReport('gst_printable_invoice_summary', event)">Printable GST Invoice Summary</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Right Interactive Viewport (9 Columns) -->
            <div class="col-lg-9 col-md-8">
                <div class="card border-0 shadow-sm">
                    <!-- Report Header -->
                    <div class="card-header bg-white border-bottom-0 pt-4 pb-0 d-flex flex-wrap justify-content-between align-items-center">
                        <div class="text-start">
                            <h4 class="fw-bold mb-1 text-dark" id="active-report-title">Today Sales</h4>
                            <p class="text-muted small mb-0" id="active-report-desc">Full details of patti sales recorded during the current operational day.</p>
                        </div>
                        
                        <!-- Main Print & Export Buttons -->
                        <div class="d-flex align-items-center gap-2 mt-2 mt-sm-0">
                            <!-- Printer Support Dropdown -->
                            <div class="dropdown">
                                <button class="btn btn-outline-primary btn-sm dropdown-toggle fw-bold" type="button" id="printReportDropdown" data-bs-toggle="dropdown">
                                    <i class="fas fa-print me-1"></i> Print
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 text-start" style="z-index: 1050;">
                                    <li><a class="dropdown-item fw-bold" href="#" onclick="ReportLogic.printActiveReport('A4')"><i class="far fa-file-pdf me-2 text-danger"></i> A4 Print Layout</a></li>
                                    <li><a class="dropdown-item fw-bold" href="#" onclick="ReportLogic.printActiveReport('80mm')"><i class="fas fa-receipt me-2 text-primary"></i> Thermal Print (80mm)</a></li>
                                    <li><a class="dropdown-item fw-bold" href="#" onclick="ReportLogic.printActiveReport('58mm')"><i class="fas fa-receipt me-2 text-secondary"></i> Thermal Print (58mm)</a></li>
                                </ul>
                            </div>
                            
                            <button class="btn btn-outline-success btn-sm fw-bold" onclick="ReportLogic.exportActiveExcel()">
                                <i class="fas fa-file-excel me-1"></i> Excel
                            </button>
                            
                            <div class="dropdown">
                                <button class="btn btn-outline-danger btn-sm dropdown-toggle fw-bold" type="button" id="pdfReportDropdown" data-bs-toggle="dropdown">
                                    <i class="fas fa-file-pdf me-1"></i> PDF
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 text-start" style="z-index: 1050;">
                                    <li><a class="dropdown-item fw-bold" href="#" onclick="ReportLogic.exportActivePDF('p')"><i class="fas fa-arrows-alt-v me-2 text-danger"></i> PDF Portrait Mode</a></li>
                                    <li><a class="dropdown-item fw-bold" href="#" onclick="ReportLogic.exportActivePDF('l')"><i class="fas fa-arrows-alt-h me-2 text-danger"></i> PDF Landscape Mode</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item small text-muted font-monospace" href="#" onclick="ReportLogic.viewPDFHistory()"><i class="fas fa-history me-2"></i> View PDF Export History</a></li>
                                </ul>
                            </div>

                            <button class="btn btn-success btn-sm fw-bold" onclick="ReportLogic.openWhatsAppMenu()">
                    ...
                    <!-- Filter Control Bar -->
                    <div class="card-body bg-light border-top border-bottom py-3 px-4 my-3 text-start">
                        <div class="row g-2 align-items-end">
                            <!-- Search Bar -->
                            <div class="col-md-3">
                                <label class="small text-muted mb-1 fw-bold">Live Search</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-white"><i class="fas fa-search"></i></span>
                                    <input type="text" class="form-control" id="rep-live-search" placeholder="Type to filter..." oninput="ReportLogic.applyFilters()">
                                </div>
                            </div>
                            
                            <!-- Date Filters -->
                            <div class="col-md-2" id="div-from-date">
                                <label class="small text-muted mb-1 fw-bold">From Date</label>
                                <input type="date" class="form-control form-control-sm" id="rep-from-date" onchange="ReportLogic.applyFilters()">
                            </div>
                            <div class="col-md-2" id="div-to-date">
                                <label class="small text-muted mb-1 fw-bold">To Date</label>
                                <input type="date" class="form-control form-control-sm" id="rep-to-date" onchange="ReportLogic.applyFilters()">
                            </div>

                            <!-- Payment Method Filter (Shows dynamically for sales/payments) -->
                            <div class="col-md-2" id="div-payment-filter">
                                <label class="small text-muted mb-1 fw-bold">Payment Mode</label>
                                <select class="form-select form-select-sm" id="rep-payment-filter" onchange="ReportLogic.applyFilters()">
                            ...
                            <div class="col-md-3 d-flex gap-2">
                                <button class="btn btn-outline-secondary btn-sm flex-fill fw-bold" onclick="ReportLogic.openAdvancedFilters()">
                                    <i class="fas fa-filter me-1"></i> Advanced
                                </button>
                                <button class="btn btn-primary btn-sm flex-fill fw-bold" onclick="ReportLogic.refreshActiveReport()">
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-2" id="active-filter-badges">
                            <!-- Dynamic Badges -->
                        </div>
                    </div>

                    <!-- Main Content Rendering Area -->
                    <div class="card-body p-0" id="report-view-container">
                        <!-- Chart Area -->
                        <div id="chart-area-wrapper" class="p-4 d-none border-bottom bg-white">
                            <div style="height: 300px; position: relative; width: 100%;">
                                <canvas id="reportsChartCanvas"></canvas>
                            </div>
                        </div>
                        
                        <!-- Table Area -->
                        <div class="table-responsive" style="max-height: 520px; overflow-y: auto;">
                            <table class="table table-hover align-middle mb-0 text-start" id="active-report-table">
                                <thead class="table-light sticky-top" style="z-index: 1;">
                                    <tr id="active-report-thead">
                                        <!-- Dynamic headers -->
                                    </tr>
                                </thead>
                                <tbody id="active-report-tbody">
                                    <!-- Dynamic records rows -->
                                </tbody>
                                <tfoot class="table-dark font-monospace align-middle text-end" id="active-report-tfoot">
        ...
        <div class="modal fade" id="advancedFilterModal" tabindex="-1" aria-hidden="true" style="z-index: 1060;">
            <div class="modal-dialog">
                <div class="modal-content shadow border-0 text-start">
                    <div class="modal-header bg-dark-blue text-white">
                        <h5 class="modal-title fw-bold"><i class="fas fa-sliders-h me-2"></i>Advanced Report Filters</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-4">
                        <form id="adv-filter-form" onsubmit="event.preventDefault(); ReportLogic.applyAdvancedFilters();">
                            <div class="mb-3">
                                <label class="form-label small fw-bold">Filter by Customer / Party</label>
                                <select class="form-select" id="adv-customer-select">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="adv-product-select">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="adv-category-select">
                                    <option value="all">All Categories</option>
                                    <!-- dynamic options -->
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label small fw-bold">Filter by Cashier / Staff</label>
                                <select class="form-select" id="adv-staff-select">
                            ...
                            <div class="row g-2 mb-4">
                                <div class="col-6">
                                    <label class="form-label small fw-bold">Invoice Min. No</label>
                                    <input type="number" class="form-control" id="adv-invoice-min" placeholder="e.g. 1001">
                                </div>
                                <div class="col-6">
                                    <label class="form-label small fw-bold">Invoice Max. No</label>
                                    <input type="number" class="form-control" id="adv-invoice-max" placeholder="e.g. 1020">
                                </div>
                            </div>

                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-outline-secondary flex-fill fw-bold" onclick="ReportLogic.clearAdvancedFilters()">Clear Filters</button>
                                <button type="submit" class="btn btn-primary flex-fill fw-bold">Apply Advanced</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="modal fade" id="whatsAppTemplatesModal" tabindex="-1" aria-hidden="true" style="z-index: 1060;">
            <div class="modal-dialog">
                <div class="modal-content shadow border-0 text-start">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title fw-bold"><i class="fab fa-whatsapp me-2"></i>Send Report to WhatsApp</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-4 text-center">
                        <i class="fab fa-whatsapp fa-3x text-success mb-3 animate-pulse"></i>
                        <h5 class="fw-bold mb-3">Select WhatsApp Share Template</h5>
                        
                        <div class="mb-3 text-start">
                            <label class="form-label small fw-bold d-block">Recipient Mobile Number (10 digits)</label>
                            <input type="tel" class="form-control form-control-lg text-center font-monospace fw-bold" id="wa-share-phone" placeholder="e.g. 9876543210" pattern="[0-9]{10}">
                        </div>

                        <div class="d-grid gap-2 text-start">
                            <button class="btn btn-outline-success py-3 fw-bold d-flex align-items-center gap-3 text-start" onclick="ReportLogic.shareWATemplate('daily_summary')">
                                <i class="fas fa-file-invoice-dollar fa-lg text-success"></i>
                                <div>
                                    <div class="fw-bold text-dark">1. Daily Sales Summary</div>
                                    <small class="text-muted d-block" style="font-size: 10px;">Total bills count, gross sales, payment breakdown</small>
                                </div>
                            </button>
                            <button class="btn btn-outline-success py-3 fw-bold d-flex align-items-center gap-3 text-start" onclick="ReportLogic.shareWATemplate('monthly_summary')">
                                <i class="fas fa-chart-line fa-lg text-success"></i>
                                <div>
                                    <div class="fw-bold text-dark">2. Monthly Performance Report</div>
                                    <small class="text-muted d-block" style="font-size: 10px;">Net summary, category trends, overall collections</small>
                                </div>
                            </button>
                            <button class="btn btn-outline-success py-3 fw-bold d-flex align-items-center gap-3 text-start" onclick="ReportLogic.shareWATemplate('due_reminder')">
                                <i class="fas fa-hand-holding-usd fa-lg text-success"></i>
                                <div>
                                    <div class="fw-bold text-dark">3. Customer Due Balance Reminder</div>
                                    <small class="text-muted d-block" style="font-size: 10px;">Pending collections alert, invoice list, ledger reference</small>
                                </div>
                            </button>
                        </div>
                    </div>
        ...
        <!-- PDF Save History Dialog -->
        <div class="modal fade" id="pdfHistoryModal" tabindex="-1" aria-hidden="true" style="z-index: 1060;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content shadow border-0 text-start">
                    <div class="modal-header bg-dark text-white">
                        <h5 class="modal-title fw-bold"><i class="fas fa-history me-2"></i>Saved PDF Export History</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-0">
                        <div class="table-responsive">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h6 class="fw-bold text-dark mb-0"><i class="fas fa-users-cog text-primary me-2"></i>Staff Accounts & Cashiers</h6>
                                            <button class="btn btn-sm btn-primary fw-bold" onclick="app.openStaffModal()"><i class="fas fa-user-plus me-1"></i> Add New Staff</button>
                                        </div>
...
2. Please settle pending outstanding within due limits.</textarea>
        ...
        <!-- STAFF MODAL -->
        <div class="modal fade" id="staffModal" tabindex="-1" aria-hidden="true" style="z-index: 1070;">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-header bg-primary text-white py-3">
                        <h5 class="modal-title fw-bold" id="staff-modal-title"><i class="fas fa-user-plus me-2"></i> Add New Staff Account</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="staff-form" onsubmit="event.preventDefault(); app.saveStaffMember();">
                        <div class="modal-body p-4 text-start">
                            <input type="hidden" id="staff-id">
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Staff Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="staff-name" placeholder="e.g. Ramesh Kumar" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Login Username <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="staff-username" placeholder="e.g. ramesh_billing" required>
                                <div class="form-text text-muted" style="font-size: 11px;">This must be unique across the shop.</div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-6">
                                    ...
                                    <select class="form-select" id="staff-role-select" required>
                                        <option value="Cashier">Cashier (POS Operator)</option>
                                        <option value="Manager">Manager (POS + Rates Manager)</option>
                                        <option value="Loader">Loader (Staff Member)</option>
                                    </select>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="staff-phone" placeholder="e.g. 9876543210">
                            </div>
                        </div>
                        <div class="modal-footer bg-light border-top-0 p-3">
                            ...
                            <button type="submit" class="btn btn-primary fw-bold px-4">Save Staff Account</button>
                        </div>
                    </form>
                </div>
            </div>
